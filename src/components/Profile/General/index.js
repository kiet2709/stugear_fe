  ...
  return (
        <div className="tab-pane fade active show" id="account-general">
            <div className="card-body row d-flex media align-items-center">
                <div className="col-2">
                    <img src={`http://127.0.0.1:8000/api/users/${localStorage.getItem("user_id")}/images`} alt="" className="img-fluid" />
                </div>
                <div className="media-body col">
                    <label className="btn btn-outline-primary">
                        Thay đổi ảnh đại diện
                        <input type="file" className="account-settings-fileinput" onSubmit={(e) => handleUploadImage(e)} />
                    </label>
